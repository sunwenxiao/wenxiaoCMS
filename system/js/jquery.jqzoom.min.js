...
$(function(){
	...
	div.jqZoomPup { z-index: 10; visibility: hidden; position: absolute; top:0px; left:0px; width: \
	50px; height: 50px; border: 1px solid #aaa; background: #ffffff url() 50% top no-repeat;\
